...
with col1:
        symbol = st.selectbox("Symbol", ["SOL", "ETH","BTC","TRX", "ADA",  "BCH", "PEOPLE", "IOTX", "POL","ATOM", "C98", "AAVE","DOT","MANA","CAKE", "XRP","BNB","PEP","UNI","DENT", "SHIB", "DOGE", "HOT", "CELR", "VET", "XLM", "ALGO", "GBP", "AUD","XAU", "EUR",])
with col2:
